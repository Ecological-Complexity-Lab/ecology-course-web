...
const ECOLOGY_CLASSES = [
  ...
  { num: 4, label: 'רשתות אקולוגיות',         file: 'class-4-networks.html',            desc: 'צמתים, קשתות ומטריצות · סוגי רשתות · ייצוג ומטריצות · תהליכים ורשתות רב-שכבתיות.', ready: true,
    topics: [
      { id: 'p1', label: 'רשתות ומערכות מורכבות' },
      { id: 'p2', label: 'סוגי רשתות אקולוגיות' },
      { id: 'p3', label: 'ייצוג ומטריצות' },
      { id: 'p4', label: 'תהליכים, רב-שכבתיות וסיכום' },
    ] },

...
const ECOLOGY_CLASSES = [
  ...
  { num: 4, label: 'רשתות אקולוגיות',         file: 'class-4-networks.html',            desc: 'צמתים, קשתות ומטריצות · סוגי רשתות · שרשראות מזון · תהליכים ורשתות רב-שכבתיות.', ready: true,
    topics: [
      ...
      { id: 'p5', label: 'תהליכים, רב-שכבתיות וסיכום' },
    ] },
